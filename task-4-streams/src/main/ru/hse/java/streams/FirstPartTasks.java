...
public final class FirstPartTasks {
    ...
    public static List<Album> sortedFavorites(Stream<Album> albums) {
        return albums
                .filter(t -> t.getTracks().stream().anyMatch(r -> r.getRating() > 95))
    ...
    public static Map<Artist, List<String>> groupByArtistMapName(Stream<Album> albums) {
        return albums.collect(Collectors.groupingBy(a -> a.getArtist(), Collectors.mapping(Album::getName, Collectors.toList())));
    }
    ...
    public static List<Album> sortByAverageRating(Stream<Album> albums) {
        return albums.sorted(Comparator.comparing((Album a) -> a.getTracks()
                                    .stream()
